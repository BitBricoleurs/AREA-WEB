...
const SideBarSettings = ({node, onClose}) => {
    ...
    return (
        <div id="drawer-navigation" className="fixed top-0 right-0 z-60 w-64 h-screen p-4 overflow-y-auto bg-white dark:bg-gray-800" aria-labelledby="drawer-navigation-label">
