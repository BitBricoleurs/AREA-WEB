            ...
            >
                <div className="h-full px-2 pb-4 overflow-y-auto">
                    <ul className="space-y-2 font-medium">
                        <li className={`flex items-center p-2 rounded-lg ${isCurrentPage('dashboard') ? 'bg-light-purple text-white' : 'text-custom-grey hover:bg-light-purple hover:bg-opacity-30 hover:text-white group'}`}>
                        ...
                        <li className={`flex items-center p-2 rounded-lg ${isCurrentPage('search') ? 'bg-light-purple text-white' : 'text-custom-grey hover:bg-light-purple hover:bg-opacity-30 hover:text-white group'}`}>
                        ...
                        <li className={`flex items-center p-2 rounded-lg ${isCurrentPage('automate') ? 'bg-light-purple text-white' : 'text-custom-grey hover:bg-light-purple hover:bg-opacity-60 hover:text-white group'}`}>
                        ...
                        <li className={`flex items-center p-2 rounded-lg ${isCurrentPage('analytics') ? 'bg-light-purple text-white' : 'text-custom-grey hover:bg-light-purple hover:bg-opacity-30 hover:text-white group'}`}>
                            <Link to="#" className="flex items-center">
                                <svg className="fill-custom-grey group-hover:fill-white" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fillRule="evenodd" clipRule="evenodd" d="M2 7C2 4.23858 4.23858 2 7 2H17C19.7614 2 22 4.23858 22 7V17C22 19.7614 19.7614 22 17 22H7C4.23858 22 2 19.7614 2 17V7ZM7 4C5.34315 4 4 5.34315 4 7V17C4 18.6569 5.34315 20 7 20H17C18.6569 20 20 18.6569 20 17V7C20 5.34315 18.6569 4 17 4H7Z"/>
                        ...
                        <li className={`flex items-center p-2 rounded-lg ${isCurrentPage('settings') ? 'bg-light-purple text-white' : 'text-custom-grey hover:bg-light-purple hover:bg-opacity-30 hover:text-white group'}`}>
                            <Link to="#" className="flex items-center">
                                <svg className="fill-custom-grey group-hover:fill-white " width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
